...
namespace LibwareLib
{
	internal class Employee1
	{
		...
		public static void Main(String[] args)
		{
			...
			Employee1 S = new Employee1(4615, "Neetu kumari", 15000.0);
			Console.WriteLine("EMP id : {0}",S.empNo);
			Console.WriteLine("EMP Name: {0}",S.empName);
			Console.WriteLine("EMP salary: {0}",S.calculateGrossSalary());
		}
